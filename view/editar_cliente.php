...
<body>
    ...
    <div class="container">
        ...
        <div class="form-section">
            ...
            <form id="formCliente" action="../controllers/cliente_controller.php" method="POST" onsubmit="return validarFormulario()">
    ...
    <script>
        function validarFormulario() {
            ...
            const cartao_credito = document.getElementById('cartao_credito').value.trim();
